...
module.exports = async (imageBuffer) => {
  ...
  // find average of black vs white pixels.
  const avg = mean(colorList);

  console.log((avg >= 0.22) ? "Black Image" : "White Image");

  // true:  image is light and black text is required
  // false: image is dark and white text is required
